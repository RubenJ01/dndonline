...
async def classtest(*argument):
	...
	if classfinal in data:
		...
		embed.add_field(name="Equipment3", value="You start with the following equipment, in addition to the equipment granted by your background:" + "\n" + f'-{equipment1}' + "\n" + f'-{equipment2}' + "\n" + f'-{equipment3}', inline=False}
		await client.say(embed=embed)
	else:
...
async def help(ctx):
	...
	embed.add_field(name=";spell", value="Find the details of any 5e spell (format like: ;spell 9spellname) please not that some might be missing", inline=False)
