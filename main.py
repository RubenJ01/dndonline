...
async def on_member_join(member):
	strings = ["Welcome to the Tavern! Please leave your bears at the Bear Post.",
		...
		"tasis pod malfunction. Prepare to discontinue hypersleep. You have been in stasis for...nine...million...nine...hundred...thousand...",
		...
		"WWe welcome patrons of all races and walks of life...so it's frowned upon to ask the Tabaxi if they are a furry.",
